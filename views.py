...
<style>
  ...
  .heading { font-family: 'Press Start 2P'; color: #FFAE28; }
.spin {
...
<div class="row">
    <div class="col-md-6 offset-md-3">
        <div class="text-center" style="padding: 64px">
          <div class="box">
            <h3 class="heading">Quackers!</h3> 
          </div>
          <div class="box">
            <!-- <h5 class="heading">About</h5> -->
            Welcome to our workshops! This one's being run by Lachlan and Will, two of the world's foremost DuckCTF organisers. They're probably going to talk about cryptography and OSINT and stuff. It's going to be a good time! Come back on Thursday if you want to hack Minesweeper.
            <!-- <p>The competition will start at 6:00pm, August 3rd 2023, in the A3C Cyber Range. <span style="color: #16324f">(motor.smart.wires)</span></p> -->
          </div>
          <div class="box">
            DuckCTF is brought to you by the <a href="https://adelaideb9.com/"><marquee scrollamount="1">CTF squad master general, Michelin Star mafia, holders of the emerald AES keys, six foot vertical leap, Michelle Obama's good friend, level 99 woodcutting, please like and subscribe 👍, their royal highnesses AdelaideB9 thou shall tremble clef before thee, the seventh.</marquee></a>
            in collaboration with <a class="spin" href="https://csclub.org.au/404.html">
            <div class="waviy"><span style="--i:1">C</span><span style="--i:2">S</span> <span style="--i:3"> </span><span style="--i:4">C</span><span style="--i:5">l</span><span style="--i:6">u</span><span style="--i:7">b</span>
            </div>
            </a>.
          </div>
        </div>
